// connect to the database and seed (write) documents in it, in this case books
...
Movie.create(movies)
  .then((createdMovies) => {
      ...
      //close the connection after creating the items
      mongoose.connection.close()
  })
  .catch((err) =>{
      console.log('An error ocurred on the creation', err)
  })
